  ...
  return (
    <>
      <section className="page-header">
        <h1>Quest Esports Rulebook</h1>
        <p>Official VALORANT Tournament Rules</p>
      </section>
        ...
        <div className="form-container">
          ...
          <div className="rulebook-section">
            ...
            <ul className="rule-list">
              <li>
                All players must register and compete using their own valid Riot
                ID.
              </li>
              <li>
                Using another player’s account, fake information, or false
                identity is strictly prohibited.
              </li>
              <li>
                Quest Esports may request identity verification using NIC,
                passport, student ID, or equivalent documents.
              </li>
              <li>
                Failure or refusal to provide verification may result in
                immediate disqualification.
              </li>
              <li>
                Team rosters become locked once the team has played its first
                official match.
              </li>
              <li>
                No roster changes are allowed after the first official match
                unless Quest Esports approves an exceptional case.
              </li>
              <li>
                Team names, player names, logos, and profile images must not
                contain offensive, obscene, or discriminatory content.
              </li>
            </ul>
            ...
            <ul className="rule-list">
              ...
              <li>
                Stand-ins who are not officially registered are not allowed in
                online events.
              </li>
            </ul>
            ...
            <ul className="rule-list">
              <li>
                Online tournaments: teams must check in 30 minutes before the
                match start time.
              </li>
              <li>
                LAN tournaments: teams must check in 1 hour before the match
                start time.
              </li>
              <li>
                A team not ready within 10 minutes of the official start time
            ...
            <ul className="rule-list">
              ...
              <li>
                Any server change must be approved by tournament admins before
                the match begins.
              </li>
              <li>Once the match starts, the server cannot be changed.</li>
              <li>
                If both teams do not agree, the Singapore server will be used.
              </li>
            </ul>
            ...
            <ul className="rule-list">
              ...
              <li>
                Coaches may communicate only during map/agent select, tactical
                timeouts, halftime, and between maps.
              </li>
              <li>
                Teams may use Discord, TeamSpeak, or similar communication
                platforms.
              </li>
            ...
            <ul className="rule-list">
              <li>
                Hacking, scripting, macros, exploits, and third-party cheats are
                strictly prohibited.
              </li>
              <li>
                Smurfing, account sharing, or impersonation results in instant
                disqualification.
              </li>
              <li>
                Match-fixing, collusion, or bribery may result in a permanent
                ban.
              </li>
              <li>
                Toxicity, harassment, or discrimination may result in immediate
                disqualification.
              </li>
            ...
            <ul className="rule-list">
              <li>
                Quest Esports may adjust schedules, formats, or match outcomes
                when necessary to ensure fairness.
              </li>
              <li>
                Prize distribution timelines and requirements will be announced
            ...
            <ul className="rule-list">
              ...
              <li>
                The team captain must provide bank details within 3 days after
                the tournament ends.
              </li>
            </ul>
            ...
            <ul className="rule-list">
              <li>
                All Quest Esports VALORANT tournaments are currently restricted
                to Sri Lankan residents only.
              </li>
            ...
            <ul className="rule-list">
              ...
              <li>
                Another authorized tournament official must handle rulings for
                those matches.
              </li>
            </ul>
            ...
            <p>
              To update or correct player details, the Team Captain must contact
              Quest Esports using the official channels below:
            </p>
            <ul className="rule-list">
            ...
            <ul className="rule-list">
              <li>
                Corrections and roster updates are allowed only before the first
                official match.
              </li>
              <li>
                No changes are accepted once a team has started a match.
              </li>
              <li>
                Requests from non-captain or unregistered email addresses will
                not be accepted.
              </li>
            </ul>
            ...
            <ul className="rule-list">
              <li>
                Players may be changed or substitutes added only before the
                first official match.
              </li>
              <li>
                Once a team has played its first official match, the roster is
                fully locked.
              </li>
              <li>
                No further player additions or replacements are permitted after
                that point.
              </li>
            </ul>
            ...
            <ul className="rule-list">
              ...
              <li>
                Failure to comply may result in delays, penalties, or match
                forfeiture.
              </li>
            </ul>
            ...
            <ul className="rule-list">
              ...
              <li>
                When a coach is present, the whole team must stay in the same
                Discord voice channel with the coach throughout the match.
              </li>
              <li>
                If the team has no coach, the Team Captain or Team Leader must
                remain on Discord during the match.
              </li>
              <li>
                If webcams are required by tournament admins, all players must
                keep webcams on for the entire match.
              </li>
              <li>
                Webcam feeds may be used for live broadcasts and competitive
            ...
            <ul className="rule-list">
              <li>
                Players using a mobile phone as a webcam must disable screen
                lock or auto-rotate lock.
              </li>
            ...
            <ul className="rule-list">
              <li>
                Players must follow the approved webcam angles given by
            ...
            <ul className="rule-list">
              <li>
                Disabling the webcam, closing Spectra, using unapproved angles,
                or entering incorrect Riot ID details may result in warnings,
                penalties, forfeits, or disqualification.
              </li>
              <li>
                Additional Spectra or webcam instructions may be given by admins
                when required.
              </li>
            </ul>
          </div>
          ...
          <div className="rulebook-section">
            ...
            <p>
              Approved face camera angle examples for player verification and
              monitoring.
            </p>
          ...
          <div className="rulebook-section">
            ...
            <ul className="rule-list">
              ...
              <li>
                Minimum age is 10 years, and parental consent is required for
                players under 16.
              </li>
            ...
            <ul className="rule-list">
              ...
              <li>
                Preliminary matches may be BO1 or BO3 depending on the number of
                teams.
              </li>
            ...
            <ul className="rule-list">
              <li>
                Video verification through Zoom, Discord, or Google Meet may be
                mandatory when requested.
              </li>
              <li>
                Teams must inform organizers of the chosen platform 30 minutes
                before the match.
              </li>
            ...
            <ul className="rule-list">
              <li>
                Each team is allowed 1 technical pause per map for a maximum of
                10 minutes.
              </li>
              <li>
                Each team is allowed 1 tactical timeout per side per map, plus 1
                in overtime.
              </li>
            </ul>
            ...
            <p className="rulebook-note">
              ...
              rulebooks and/or VCT tournament broadcasts and are included only
          ...
          <div className="rulebook-section">
            ...
            <p>
              Examples of correct and incorrect camera setups for player
              monitoring.
            </p>
