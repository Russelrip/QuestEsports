...
export type AdminNavigationLink = {
  ...
  label: string;
  icon: NavIconKey;
  // The staff area that also opens this link for someone who is not an admin.
  // Links without one are admin-only.
...
export type AdminUser = {
  ...
  // Staff roles the user holds. Only the users list reports it.
  staffRoles?: Array<{ id: string; name: string; color: string | null }>;
};
