  ...
  function Input({ className, type, onChange, disabled, ...props }, ref) {
    ...
    if (type === "file") {
      return (
        <span
          className={cn(
            "relative flex min-h-12 w-full items-center gap-3 overflow-hidden border border-white/10 bg-black/30 p-1.5 text-sm transition focus-within:border-cyan-300/40 focus-within:ring-4 focus-within:ring-cyan-400/10",
