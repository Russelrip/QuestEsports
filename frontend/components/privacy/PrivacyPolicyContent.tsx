...
const policySections = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "To send account-related emails such as verification, password reset, and security alerts. Team invitations are not emailed: an invitation is held in your Quest account and you find it by signing in.",
