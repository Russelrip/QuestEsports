      ...
      {loading ? (
        ...
        <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
          {posters.map((poster) => {
            ...
            const card = (
              <Card className="group overflow-hidden transition duration-300 hover:-translate-y-1 hover:border-cyan-300/30 hover:shadow-[0_20px_60px_rgba(34,211,238,0.12)]">
