    ...
    <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#08070d]">
      ...
      <Container className="relative flex min-h-[58svh] items-end py-12 sm:min-h-[64svh] sm:py-20">
        <div className="max-w-4xl">
          <Link href="/tournaments" className="text-sm text-slate-300 underline-offset-4 transition hover:text-white hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-purple-300">Back to tournaments</Link>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            ...
            <Link href="#tournaments" className={buttonClassName({ size: "lg", className: "border-purple-300/30 bg-purple-400/15 hover:bg-purple-400/25" })}>Explore games <span aria-hidden="true">↓</span></Link>
          </div>
        </div>
      </Container>
    </section>
