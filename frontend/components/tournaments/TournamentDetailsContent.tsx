...
function TournamentOverviewSidebar({ tournament }: { tournament: Tournament }) {
  ...
  const rows = [
    ...
    {
      label: "Slots",
      value: tournament.maxTeams === null
        ? `${tournament.capacityUsed ?? tournament.registrationCount} registered · unlimited`
        : `${tournament.capacityUsed ?? tournament.registrationCount} / ${tournament.maxTeams}`,
    },
