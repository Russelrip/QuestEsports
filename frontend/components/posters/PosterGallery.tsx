...
export default function PosterGallery({
  ...
  return (
    <Section className="pt-6">
      <div className="mb-6">
        <p className="text-xs uppercase tracking-[0.28em] text-purple-200/80">Event Gallery</p>
          ...
          {posters.map((poster) => {
            ...
            return externalLink ? (
              <a
                ...
                className="cursor-pointer rounded-none text-left outline-none focus-visible:ring-2 focus-visible:ring-purple-300"
              >
                {card}
              </a>
            ) : (
