        ...
        <div className="mt-5 rounded-[20px] border border-amber-300/20 bg-amber-400/8 p-4">
          ...
          <div className="mt-4 grid gap-2 sm:grid-cols-2">
            {backupCodes.map((code) => (
              <div key={code} className="min-w-0 break-words rounded-2xl border border-white/8 bg-black/20 px-3 py-2 font-mono text-sm text-slate-100 [overflow-wrap:anywhere]">
                {code}
              </div>
            ))}
          </div>
