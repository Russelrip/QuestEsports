...
SSH_LOG="$ssh_log" REMOTE_ARG_LOG="$remote_arg_log" FAKE_REMOTE_SCRIPT="$work_directory/fake-remote-script" SSH_MATERIAL_DIR="$ssh_material" RUNNER_TEMP="$ssh_runner_temp" RELEASE_MODE=normal RELEASE_SHA=1111111111111111111111111111111111111111 SSH_HOST=example.test SSH_PORT=2222 SSH_USER=deploy PATH="$mock_bin:$PATH" bash "$compose_transfer"
