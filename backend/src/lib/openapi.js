    ...
    schemas: {
      ...
      Tournament: {
        ...
        properties: {
          ...
          startDateStatus: { type: "string", enum: ["scheduled", "tba", "tbd"] },
          endDate: { type: ["string", "null"], format: "date-time" },
          endDateStatus: { type: "string", enum: ["scheduled", "tba", "tbd"] },
          registrationDeadline: { type: ["string", "null"], format: "date-time" },
          registrationDeadlineStatus: { type: "string", enum: ["scheduled", "tba", "tbd"] },
...
const additionalPaths = {
  ...
  "/api/admin/team-registrations/{registrationId}/roster": { patch: createOperation("Admin", "Correct a registration roster", { authenticated: true, parameters: idParameter("registrationId") }) },
